...
from parsl.executors.globus import GlobusExec
...
def fresh_config():
    return Config(
        executors=[GlobusExec(endpoint_list = ['fa11b360-9f04-4df8-903e-81fc706fd21c', '8e7f13f5-5a89-49c6-85b4-f8929cb0d8ae'], max_threads = 1)]
    )
