...
class FuncXExec(NoStatusHandlingExecutor, RepresentationMixin):
    ...
    def start(self):
        self.Executor_list = []
        c = Client()
        self.gce = Executor(endpoint_id = self.endpoint_id, funcx_client = c)
    ...
    def submit(self, func, resource_specification, *args, **kwargs):
        ...
        return self.gce.submit(func, *args, **kwargs)
